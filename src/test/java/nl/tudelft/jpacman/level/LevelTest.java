...
class LevelTest {
    ...
    void registerFourthPlayer() {
        ...
        level.registerPlayer(p2);
        level.registerPlayer(p3);
        level.registerPlayer(p4);
        level.registerPlayer(p5);
        level.registerPlayer(p6);
        verify(p3).occupy(square1);
        verify(p4).occupy(square2);
        verify(p5).occupy(square1);
        verify(p6).occupy(square2);
